    ...
    <div class="row">
        <div class="col-9">
            <div class="row">
                ...
                <?= $form->field($model, 'custom[missao]', wraper(12))->textarea(['value' => $model->custom['missao'] ?: '', 'rows' => 4])->label('Missão') ?>
                <?= $form->field($model, 'custom[visao]', wraper(12))->textarea(['value' => $model->custom['visao'] ?: '', 'rows' => 4])->label('Visao') ?>
                <?= $form->field($model, 'custom[valores]', wraper(12))->textarea(['value' => $model->custom['valores'] ?: '', 'rows' => 4])->label('Valores') ?>

        ...
        <div class="row">
            <div class="col-9">
                <div class="row">
                    ...
                    <?= $form->field($model, 'price', wraper(6))->textInput(['maxlength' => true]) ?>

                    <?= $form->field($model, 'sale_price', wraper(6))->textInput(['maxlength' => true]) ?>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="position: relative">
                        <div id="thumbnail" data-toggle="modal" data-target="#media-manager" style="position: relative; min-height: 100px; background: url(<?= Url::to('@web/storage/') . 'placeholder.png'?>); background-size: cover; background-position: center center">
                            ...
                            <input id="thumbnail-input" type="hidden" name="Produtos[image]" value="<?= $model->image ?: '' ?>">
                        </div>

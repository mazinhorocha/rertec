    ...
    <div class="row">
        <div class="col-9">
            <div class="row">
                ...
                <?= $form->field($model, 'numeros', wraper(3))->textInput(['maxlength' => true]) ?>

                <?= $form->field($model, 'strong', wraper(3))->textInput(['maxlength' => true]) ?>

                <?= $form->field($model, 'resume', wraper(12))->textarea(['rows' => 3, 'maxlength' => true]) ?>
            </div>
        </div>
        <div class="col-3">
